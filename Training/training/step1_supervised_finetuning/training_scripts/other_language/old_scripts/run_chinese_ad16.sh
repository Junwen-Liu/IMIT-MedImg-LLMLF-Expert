...
OUTPUT_PATH=./output_chinese_bloom_1b1_16_zh_new
mkdir -p $OUTPUT_PATH
...
deepspeed --master_port=29501 /home/junwen/DeepSpeed-Chat/training/step1_supervised_finetuning/main.py \
   --data_path pancreatic-surgery \
   --data_split 10,0,0 \
