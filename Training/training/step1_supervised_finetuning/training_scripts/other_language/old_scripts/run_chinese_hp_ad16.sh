...
OUTPUT_PATH=./output_chinese_bloom_hp_16_zh_added
mkdir -p $OUTPUT_PATH
...
deepspeed --master_port=29502 /home/junwen/DeepSpeed-Chat/training/step1_supervised_finetuning/main.py \
   --data_path hepatobiliary \
   --data_split 10,0,0 \
