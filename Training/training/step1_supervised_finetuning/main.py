...
def parse_args():
    ...
    parser.add_argument('--data_path',
                        nargs='*',
                        default=['wangrui6/Zhihu-KOL Cohere/miracl-zh-queries-22-12 Hello-SimpleAI/HC3-Chinese mkqa-Chinese'],
...
def main():
    ...
    for epoch in range(args.num_train_epochs):
        print_rank_0(
            f"Beginning of Epoch {epoch+1}/{args.num_train_epochs}, Total Micro Batches {len(train_dataloader)}, Total Eval Batches {len(eval_dataloader)}",
            args.global_rank)
        model.train()
