...
class DahoasRmstaticDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
       ...
       # self.raw_datasets = load_dataset("Dahoas/rm-static")
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/dahoas_rm_static')
...
class DahoasFullhhrlhfDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
       ...
       # self.raw_datasets = load_dataset("Dahoas/full-hh-rlhf")
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/dahoas_full_hh_rlhf')
...
class DahoasSyntheticinstructgptjpairwiseDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
        ...
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/Dahoas_synthetic_instruct_gptj_pairwise')
...
class YitingxieRlhfrewarddatasetsDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
       ...
       # self.raw_datasets = load_dataset("yitingxie/rlhf-reward-datasets")
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/yitingxie_rlhf_reward_datasets')
...
class OpenaiWebgptcomparisonsDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
       ...
       # self.raw_datasets = load_dataset("openai/webgpt_comparisons")
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/openai_webgpt_comparisons')
...
class StanfordnlpSHPDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
        ...
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/stanfordnlp_SHP')
...
class Wangrui6ZhihuKOLDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
       ...
       # self.raw_datasets = load_dataset("wangrui6/Zhihu-KOL")
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/wangrui6_Zhihu_KOL')
...
class CohereMiraclzhqueries2212Dataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
        ...
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/Cohere_miracl_zh_queries_22_12')
...
# Chinese abdomenCT
class abdodmen_CTDataset(PromptRawDataset):

    def __init__(self, output_path, seed, local_rank):
        super().__init__(output_path, seed, local_rank)
        self.dataset_name = "abdomen-ct"
        self.dataset_name_clean = "abdomen_ct"
        #self.raw_datasets = load_dataset("Cohere/miracl-zh-queries-22-12")
        self.raw_datasets = load_from_disk('/IMIT_User2/junwen/abdomenCT/finetune.arrow')
    ...
    def get_prompt_and_chosen(self, sample):
        if sample['INSTRUCTION'] is not None and sample['RESPONSE'] is not None:
            return sample['INSTRUCTION'] + sample[
                'RESPONSE']
        return None
...
class abdodmen_CT_RewardDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
        ...
        self.dataset_name_clean = "abdomen_ct"
        #self.raw_datasets = load_dataset("Cohere/miracl-zh-queries-22-12")
        self.raw_datasets = load_from_disk('/IMIT_User2/junwen/abdomenCT/reward_fake.arrow')
    ...
    def get_chosen(self, sample):
        if sample['g_truth'] is not None:
            return sample['g_truth']
        return None
    ...
    def get_prompt_and_chosen(self, sample):
        if sample['instruction'] is not None and sample['g_truth'] is not None:
            return sample['instruction'] + sample['g_truth']
        return None

    def get_prompt_and_rejected(self, sample):
        if sample['instruction'] is not None and sample['rejected'] is not None:
            return sample['instruction'] + sample['rejected']
        return None

class abdodmen_CT_RLHFDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
        ...
        self.dataset_name_clean = "abdomen_ct"
        #self.raw_datasets = load_dataset("Cohere/miracl-zh-queries-22-12")
        self.raw_datasets = load_from_disk('/IMIT_User2/junwen/abdomenCT/RLHF.arrow')
...
# Chinese dataset-pancreatic-surgery
class Pancreatic_surgeryDataset(PromptRawDataset):

    def __init__(self, output_path, seed, local_rank):
        super().__init__(output_path, seed, local_rank)
        self.dataset_name = "pancreatic-surgery"
        self.dataset_name_clean = "pancreatic_surgery"
        #self.raw_datasets = load_dataset("Cohere/miracl-zh-queries-22-12")
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/pancreatic_surgery/2022total-fixed2.arrow')
...
# Chinese dataset-hepatobiliary
class HepatobiliaryDataset(PromptRawDataset):

    def __init__(self, output_path, seed, local_rank):
        super().__init__(output_path, seed, local_rank)
        self.dataset_name = "hepatobiliary"
        self.dataset_name_clean = "hepatobiliary"
        #self.raw_datasets = load_dataset("Cohere/miracl-zh-queries-22-12")
        #self.raw_datasets = load_from_disk('/home/junwen/raw-data/hepatobiliary2022total-csv.arrow')
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/hp_train_total-csv.arrow')
    ...
    def get_prompt_and_chosen(self, sample):
        if sample['INSTRUCTION'] is not None and sample['RESPONSE'] is not None:
            return  sample['INSTRUCTION'] + sample['RESPONSE']
        return None
...
# Chinese dataset-incretion
class IncretionDataset(PromptRawDataset):

    def __init__(self, output_path, seed, local_rank):
        super().__init__(output_path, seed, local_rank)
        self.dataset_name = "incretion"
        self.dataset_name_clean = "incretion"
        #self.raw_datasets = load_dataset("Cohere/miracl-zh-queries-22-12")
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/in_total_new-csv.arrow')
...
class HelloSimpleAIHC3ChineseDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
        ...
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/Hello_SimpleAI_HC3_Chinese')
...
class MkqaChineseDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
        ...
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/mkqa')
...
class CohereMiracljaqueries2212Dataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
        ...
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/Cohere_miracl_ja_queries_22_1')
...
class LmqgQgjaquadDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
        ...
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/lmqg_qg_jaquad')
...
class LmqgQagjaquadDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank):
        ...
        self.raw_datasets = load_from_disk('/home/junwen/raw-data/lmqg_qag_jaquad')
