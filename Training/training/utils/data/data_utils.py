...
def get_raw_dataset(dataset_name, output_path, seed, local_rank):
    if dataset_name == "Dahoas/rm-static":
        ...
        return raw_datasets.CohereMiraclzhqueries2212Dataset(
            output_path, seed, local_rank)
    elif dataset_name == "abdomenCT":
        return raw_datasets.abdodmen_CTDataset(
            output_path, seed, local_rank)
    elif dataset_name == "abdomenCT_reward":
        return raw_datasets.abdodmen_CT_RewardDataset(
            output_path, seed, local_rank)
    elif dataset_name == "abdomenCT_rlhf":
        return raw_datasets.abdodmen_CT_RLHFDataset(
            output_path, seed, local_rank)
    elif dataset_name == "pancreatic-surgery":
        return raw_datasets.Pancreatic_surgeryDataset(
            output_path, seed, local_rank)      
    elif dataset_name == "hepatobiliary":
        return raw_datasets.HepatobiliaryDataset(
            output_path, seed, local_rank)  
    elif dataset_name == "incretion":
        return raw_datasets.IncretionDataset(
            output_path, seed, local_rank)    
...
class PromptDataset(Dataset):
    ...
    def __init__(self, prompt_dataset, chosen_dataset, reject_dataset,
        ...
        #print('now is the lenght of loading dataset',self.__len__())
