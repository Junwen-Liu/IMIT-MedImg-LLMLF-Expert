...
```
├── /path/to/IMIT-MedImg-LLMLF-Expert/Inference
    ├── models
        ├── 3b_radiologist1
            ├── config.json
            ├── merges.txt
...
```bash
user@machine:/path/to/IMIT-MedImg-LLMLF-Expert/Inference$ python chatbot.py \
> --path ./models/3b_radiologist1 \
> --token_path ./tokenizer \
> --max_new_tokens 512 \
> --device cuda:0
...
Since our models were trained on Chinese, you may device a translation software or website to translate the inference results into English.
