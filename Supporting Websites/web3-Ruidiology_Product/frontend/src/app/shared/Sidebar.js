...
class Sidebar extends Component {
  ...
  render() {
    return (
      <nav className="sidebar sidebar-offcanvas bg-dark text-white" id="sidebar">
        <ul className="nav">
          <li className="nav-item nav-profile">
            ...
            >
              ...
              <div className="nav-profile-text">
                <span className="font-weight-bold mb-2 text-secondary">
                  <Trans>{this.context.user.username}</Trans>
                </span>
                <span className=" text-small text-info">
                  <Trans>{this.context.user.position}</Trans>
                </span>
              </div>
          ...
          {/* <li
            className={
              this.isPathActive("/dashboard") ? "nav-item active" : "nav-item active"
            }
          >
            <Link className="nav-link " to="/dashboard">
              <span className="menu-title text-info ">
                <Trans><strong>Dashboard</strong></Trans>
              </span>
              <i className="mdi mdi-home text-success menu-icon"></i>
            </Link>
          </li> */}
          {/* <li
            className={
          ...
          >
            <Link className="nav-link" to="/apps/tickets">
              <span className="menu-title">Review Cases</span>
          ...
          >
            <Link className="nav-link" to="/apps/chats">
              <span className="menu-title text-info "><strong>上腹部CT Chats</strong></span>
              <i className="mdi mdi-translate text-success menu-icon"></i>
            </Link>
          </li>
          ...
          <li className="nav-item">
            <a
              className="nav-link"
              href="http://bootstrapdash.com/demo/purple/react/documentation/documentation.html"
