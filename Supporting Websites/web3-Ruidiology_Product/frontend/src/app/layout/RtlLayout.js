            ...
            <div className="card bg-gradient-danger card-img-holder text-white">
              <div className="card-body">
                ...
                <h4 className="font-weight-normal mb-3">
                  <Trans>Total Cases</Trans>{" "}
                  <i className="mdi mdi-chart-line mdi-24px float-end ms-2"></i>
                </h4>
                <h2 className="mb-5">$ 20,000</h2>
                <h6 className="card-text">
                  <Trans>Completed</Trans> 60%
                </h6>
              </div>
            </div>
          </div>
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-info card-img-holder text-white">
              <div className="card-body">
                ...
                />
                <h4 className="font-weight-normal mb-3">
                  <Trans>Completed Cases</Trans>{" "}
                  <i className="mdi mdi-bookmark-outline mdi-24px float-end ms-2"></i>
                </h4>
                <h2 className="mb-5">13,432</h2>
                <h6 className="card-text">
                  <Trans>By senior Physician</Trans> 50%
                </h6>
              </div>
            </div>
          </div>
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-success card-img-holder text-white">
              <div className="card-body">
                ...
                />
                <h4 className="font-weight-normal mb-3">
                  <Trans>Visitors Online</Trans>{" "}
                  <i className="mdi mdi-diamond mdi-24px float-end ms-2"></i>
                </h4>
                <h2 className="mb-5">95,5741</h2>
                <h6 className="card-text">
                  <Trans>Increased by</Trans> 5%
                </h6>
              </div>
            </div>
          </div>
              ...
              <div className="card-body">
                <div className="clearfix mb-4">
                  <h4 className="card-title float-start">
                    <Trans>Visit And Sales Statistics</Trans>
                  </h4>
                  <div
              ...
              <div className="card-body">
                ...
                >
                  <ul>
                    <li>
                      <span className="legend-dots bg-info"></span>
                      <Trans>Search Engines</Trans>
                      <span className="float-end">30%</span>
                    </li>
                    <li>
                      <span className="legend-dots bg-success"></span>
                      <Trans>Direct Click</Trans>
                      <span className="float-end">30%</span>
                    </li>
                    <li>
                      <span className="legend-dots bg-danger"></span>
                      <Trans>Bookmarks Click</Trans>
                  ...
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          {" "}
                          <Trans>Fund is not recieved</Trans>{" "}
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <img
                            ...
                            alt="face"
                          />{" "}
                          <Trans>Stella Johnson</Trans>{" "}
                        </td>
                        <td>
                          {" "}
                          <Trans>High loading time</Trans>{" "}
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <img
                            ...
                            alt="face"
                          />{" "}
                          <Trans>Marina Michel</Trans>{" "}
                        </td>
                        <td>
                          {" "}
                          <Trans>Website down for one week</Trans>{" "}
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <img
                            ...
                            alt="face"
                          />{" "}
                          <Trans>John Doe</Trans>{" "}
                        </td>
                        <td>
                          {" "}
                          <Trans>Loosing control on server</Trans>{" "}
                        </td>
                        <td>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div className="d-flex mt-5 align-items-start">
                  <img
                    src={require("../../assets/images/faces/female.jpg")}
                    className="img-sm rounded-circle ms-3"
                    alt="face"
                  />
                  <div className="mb-0 flex-grow">
                    <h5 className="me-2 mb-2">
                      <Trans>School Website</Trans> -{" "}
                      <Trans>Authentication Module</Trans>.
                    </h5>
                  ...
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          {" "}
                          <Trans>Herman Beck</Trans>{" "}
                        </td>
                        <td>
                          {" "}
                          <Trans>May</Trans> 15, 2015{" "}
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          {" "}
                          <Trans>Messsy Adam</Trans>{" "}
                        </td>
                        <td>
                          {" "}
                          <Trans>Jul</Trans> 01, 2015{" "}
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          {" "}
                          <Trans>John Richards</Trans>{" "}
                        </td>
                        <td>
                          {" "}
                          <Trans>Apr</Trans> 12, 2015{" "}
                        </td>
                        <td>
