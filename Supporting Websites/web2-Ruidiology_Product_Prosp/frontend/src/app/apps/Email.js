      ...
      <div>
        ...
        <div className="email-wrapper wrapper">
          <div className="row align-items-stretch">
            <div className="mail-sidebar d-none d-lg-block col-xl-2 pt-3 bg-white">
              <div className="menu-bar">
                <ul className="menu-items">
                  ...
                  <li>
                    <a href="!#" onClick={(evt) => evt.preventDefault()}>
                      <i className="mdi mdi-upload"></i> Outbox
                    </a>
                    <span className="badge badge-pill badge-danger">3</span>
                  </li>
                  <li>
                    <a href="!#" onClick={(evt) => evt.preventDefault()}>
                      <i className="mdi mdi-star-outline"></i> Starred
                    </a>
                  </li>
                  <li>
                    <a href="!#" onClick={(evt) => evt.preventDefault()}>
                      <i className="mdi mdi-delete"></i> Trash
                    </a>
                  </li>
                </ul>
            ...
            <div className="mail-list-container col-xl-3 pt-4 pb-4 border-right bg-white">
              ...
              <div className="mail-list">
                ...
                <div className="content">
                  ...
                  <p className="message_text">
                    Hello, last date for registering for the annual music event
                    is closing in
                  </p>
                </div>
                <div className="details">
              ...
              <div className="mail-list">
                ...
                <div className="content">
                  ...
                  <p className="message_text">
                    Template Market: Limited Period Offer!!! 50% Discount on all
                    Templates.
                  </p>
                </div>
                <div className="details">
              ...
              <div className="mail-list">
                ...
                <div className="content">
                  ...
                  <p className="message_text">
                    Hi Emily, Please approve my leaves for 10 days from 10th May
                    to 20th May.
                  </p>
                </div>
                <div className="details">
              ...
              <div className="mail-list">
                ...
                <div className="content">
                  <p className="sender-name">Sarah Graves</p>
                  <p className="message_text">
                    Hello there, Make the most of the limited period offer. Grab
                    your favorites
                  </p>
                </div>
                <div className="details">
            ...
            <div className="mail-view d-none d-md-block col-xl-7 bg-white">
              <div className="row">
                <div className="col-md-12 mb-4 mt-4">
                  <div className="btn-toolbar">
                    <div className="btn-group">
                      ...
                      >
                        <i className="mdi mdi-share-alt text-primary mr-1"></i>{" "}
                        Reply
                      </button>
                      <button
                        type="button"
                      ...
                      <button
                        ...
                        className="btn btn-sm btn-outline-secondary"
                      >
                        <i className="mdi mdi-share text-primary mr-1"></i>
                        Forward
                      </button>
                    </div>
                    <div className="btn-group">
                      <button
                        ...
                        className="btn btn-sm btn-outline-secondary"
                      >
                        <i className="mdi mdi-attachment text-primary mr-1"></i>
                        Attach
                      </button>
                      <button
                        type="button"
              ...
              <div className="message-body">
                ...
                <div className="message-content">
                  ...
                  <p>
                    ...
                    design that needs your approval at the earliest.
                  </p>
                  <p>
