              ...
              <div className="card-body">
                ...
                <div className="container-fluid d-flex justify-content-between">
                  <div className="col-lg-3 pl-0">
                    <p className="mt-5 mb-2"><b>Purple React Admin</b></p>
                ...
                <div className="container-fluid w-100">
                  <a href="!#" onClick={event => event.preventDefault()} className="btn btn-primary float-end mt-4 ms-2"><i className="mdi mdi-printer mr-1"></i>Print</a>
                  <a href="!#" onClick={event => event.preventDefault()} className="btn btn-success float-end mt-4"><i className="mdi mdi-send mr-1"></i>Send Invoice</a>
                </div>
              </div>
            </div>
          </div>
