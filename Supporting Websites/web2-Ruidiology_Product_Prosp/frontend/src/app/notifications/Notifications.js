            ...
            <div className="card px-3">
              <div className="card-body">
                ...
                <p className="card-description mb-0">
                  Click on the below buttons for notifications in different
                  styles.
                </p>
                <p className="card-description">
                  Specify the predefined types of toasts - success, info, warn
                  and error
                </p>
          ...
          <div className="col-12 grid-margin">
            <div className="card px-3">
              <div className="card-body">
                ...
                <p className="card-description mb-0">
                  The <code>position</code> property can be used to specify the
                  predefined positions of toasts.
                </p>
                <p className="card-description">
                  Specify the predefined types of toasts - success, info, warn
                  and error
                ...
                <div className="template-demo d-flex justify-content-md-between flex-wrap">
                  <button
                    ...
                    onClick={() =>
                      cogoToast.info("Top Left!", { position: "top-left" })
                    }
                  >
                    Top Left
                  </button>
                  <button
                    ...
                    className="btn btn-outline-primary btn-sm"
                    onClick={() =>
                      cogoToast.info("Top Center!", { position: "top-center" })
                    }
                  >
                    Top Center
                  </button>
                  <button
                    ...
                    className="btn btn-outline-primary btn-sm"
                    onClick={() =>
                      cogoToast.info("Top Right!", { position: "top-right" })
                    }
                  >
                    Top Right
                  </button>
              ...
              <div className="card-body">
                ...
                <Alert variant="secondary">
                  ...
                  <p className="mb-0 p-3">
                    <button className="btn btn-secondary mb-2">Ok</button>
                    <button className="btn btn-inverse-secondary mb-2">
                      Cancel
                    </button>
                  </p>
                </Alert>
                <Alert variant="info">
                  ...
                  <p className="mb-0 p-3">
                    <button className="btn btn-info mb-2">Ok</button>
