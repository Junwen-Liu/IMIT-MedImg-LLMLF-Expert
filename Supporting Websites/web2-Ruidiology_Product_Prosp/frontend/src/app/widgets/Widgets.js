    ...
    datasets: [
      {
        label: "Profit",
        data: [1, 4, 8, 3, 4, 6, 1],
        backgroundColor: ["rgba(255, 178, 66, .1)"],
        borderColor: ["#ffc542"],
        borderWidth: 2,
        fill: true,
      },
          ...
          <div className="row">
              ...
              <div className="card card-statistics">
                <div className="card-body pb-0">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <h6 className="text-success font-weight-semibold ms-2">
                      +876
                    </h6>
                  </div>
            ...
            <div className="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div className="card card-statistics">
                <div className="card-body pb-0">
                  ...
                  <div className="d-flex align-items-center">
                    <h4 className="font-weight-semibold text-dark">$65,650</h4>
                    <h6 className="text-danger font-weight-semibold ms-2">
                      -43
                    </h6>
                  </div>
            ...
            <div className="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div className="card card-statistics">
                ...
                <div className="graph-wrapper">
                  <Line
                    data={this.totalunpaidInvoiceData}
                    options={this.lineOptions}
                  />
                </div>
              </div>
            ...
            <div className="col-md-4 grid-margin stretch-card">
              <div className="card aligner-wrapper">
                <div className="card-body">
                  ...
                  <div className="d-flex align-items-center">
                    <h1 className="font-weight-medium mb-2 text-dark">
                      $2,156
                    </h1>
                    <h5 className="font-weight-medium text-success ms-2">
                      −14.2%
                    </h5>
                  </div>
                  <div className="d-flex align-items-center">
              ...
              <div className="card review-card">
                <div className="card-header header-sm d-flex justify-content-between align-items-center">
                  ...
                  <div className="wrapper d-flex align-items-center">
                    ...
                    <Dropdown alignRight>
                      <Dropdown.Toggle
                        variant="btn btn-transparent p-0"
                  ...
                  <div className="list-item">
                    ...
                    <div className="content">
                      <div className="d-flex align-items-center">
                        ...
                        <small className="time ms-3 d-none d-sm-block">
                          08.34 AM
                        </small>
                        <div className="ms-auto">
                          <Rating
                            ...
                            emptySymbol={
                              <i
                                className="mdi mdi-star text-muted mr-1"
                                style={{
                                  fontSize: "20px",
                                  marginRight: "2px",
                                  display: "block",
                            ...
                            fullSymbol={
                              <i
                                className="mdi mdi-star text-primary mr-1"
                ...
                <div className="card-body">
                  ...
                  <div className="wrapper d-flex align-items-center py-2 border-bottom">
                    ...
                    <div className="wrapper ms-3">
                      ...
                      <small className="text-muted mb-0">
                        <i className="mdi mdi-map-marker-outline mr-1"></i>New
                        York City, USA
                      </small>
                    </div>
                  ...
                  <div className="wrapper d-flex align-items-center py-2 border-bottom">
                    ...
                    <div className="wrapper ms-3">
                      ...
                      <small className="text-muted mb-0">
                        <i className="mdi mdi-map-marker-outline mr-1"></i>
                        Florida, USA
                      </small>
                    </div>
                    <div className="badge badge-pill badge-success ms-auto px-1 py-1">
                ...
                <div className="card-body">
                  ...
                  <ul className="bullet-line-list">
                    <li>
                      ...
                      <p className="text-muted">
                        <i className="mdi mdi-clock"></i> 7 months ago.
                      </p>
                    </li>
                    <li>
