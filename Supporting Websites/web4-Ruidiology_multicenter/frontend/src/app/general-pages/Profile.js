                  ...
                  <div className="col-lg-4">
                    ...
                    <div className="py-4">
                      <p className="clearfix">
                        ...
                        <span className="float-end text-muted">Active</span>
                      </p>
                      <p className="clearfix">
                        <span className="float-start">Phone</span>
                        <span className="float-end text-muted">
                          006 3435 22
                        </span>
                      </p>
                      <p className="clearfix">
                        <span className="float-start">Mail</span>
                        <span className="float-end text-muted">
                          Jacod@testmail.com
                        </span>
                      </p>
                      <p className="clearfix">
                        <span className="float-start">Facebook</span>
                        <span className="float-end text-muted">
                          <a
                            href="!#"
                      ...
                      <p className="clearfix">
                        <span className="float-start">Twitter</span>
                        <span className="float-end text-muted">
                          <a
                            href="!#"
                            onClick={(event) => event.preventDefault()}
                    ...
                    <div className="profile-feed">
                        ...
                        <div className="ml-4">
                          <h6>
                            ...
                            <small className="ml-4 text-muted">
                              <i className="mdi mdi-clock mr-1"></i>10 hours
                            </small>
                          </h6>
                          <p>
                            There is no better advertisement campaign that is
                            low cost and also successful at the same time.
                          </p>
                      ...
                      <div className="d-flex align-items-start profile-feed-item">
                        ...
                        <div className="pl-4">
                          ...
                          <p>
                            When I first got into the online advertising
                            business, I was looking for the magical combination
                            that would put my website into the top search engine
                            rankings
                          </p>
                          <img
