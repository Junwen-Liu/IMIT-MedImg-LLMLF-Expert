        ...
        <div className="row">
          <div className="col-md-12">
            <button
              ...
              onClick={this.asideToggler}
            >
              <i className="mdi mdi-menu mr-0 icon-md"></i>
            </button>
              ...
              <div className="row mx-0">
                ...
                >
                  ...
                  <div className="chat-list-item-wrapper">
                    <div className="list-item">
                      ...
                      <p className="user-name">Junwen Liu</p>
                      <p className="chat-time">30min ago</p>
                      <p className="chat-text">
                        Hello everyone, Iam happy to share with you our new
                        company goals..
                      </p>
                    </div>
                    <div className="list-item">
                      ...
                      <p className="chat-text">
                        Hello jessica, i will b ein london tomorrow, hope we can
                        meer there
                      </p>
                    </div>
                    <div className="list-item">
                    ...
                    <div className="list-item">
                      ...
                      <p className="chat-text">
                        A new feature has been updated your account.Check it
                        out…
                      </p>
                    </div>
                    <div className="list-item">
                      ...
                      <p className="chat-text">
                        Hello, this is an invitation from one of the most
                        interesting teams...{" "}
                      </p>
                    </div>
                  </div>
                  <div className="sidebar-spacer">
                    <button
                      className="btn btn-block btn-gradient-success py-3"
                      type="button"
                    >
                      + New Chat
                    </button>
                    ...
                    <div className="chat-bubble incoming-chat">
                      <div className="chat-message">
                        <p>
                          ...
                          Sed enim ut sem viverra aliquet eget sit. Aenean et
                          tortor at risus viverra.
                        </p>
                        <p>
                          Mi in nulla posuere sollicitudin aliquam ultrices.
                          Mauris a diam maecenas sed enim. Facilisi nullam
                          vehicula ipsum a arcu cursus vitae congue mauris. In
                          cursus turpis massa tincidunt dui. Mattis vulputate
                    ...
                    <div className="chat-bubble outgoing-chat">
                      <div className="chat-message">
                        ...
                        <p className="font-weight-medium">
                          <i className="mdi mdi-paperclip me-2"></i>workfile.pdf
                        </p>
                      </div>
                      <div className="sender-details">
                        <img
                ...
                <div className="col-xl-3 d-none d-lg-block px-0 chat-sidebar">
                  <img
                    ...
                    src={require("../../assets/images/chat/profile_image.jpg")}
                    alt="profile"
                  />
                  <div className="px-4">
                    <div className="d-flex pt-4">
                      <div className="wrapper">
                        <h5 className="font-weight-medium mb-0 ellipsis">
                          Cecelia Benson
                        </h5>
                        <p className="mb-0 text-muted ellipsis">
                          General manager
                        </p>
                      </div>
                      <div className="badge badge-gradient-success mb-auto ms-auto">
                        Online
                      </div>
                    </div>
                    <div className="pt-3">
                      ...
                      <div className="d-flex align-items-center py-1">
                        ...
                        <p className="mb-0 font-weight-medium ellipsis">
                          cecilia.tromp@danny.com
                        </p>
                      </div>
                      <div className="d-flex align-items-center py-1">
                    ...
                    <div className="list-item">
                      <div className="d-flex align-items-center justify-content-center img-sm badge-gradient-success">
                        <i className="mdi mdi-cash-multiple icon-sm"></i>
                      </div>
                    ...
                    <div className="list-item">
                      <div className="d-flex align-items-center justify-content-center img-sm badge-gradient-danger">
                        <i className="mdi mdi-cash-multiple icon-sm"></i>
                      </div>
                      <div className="wrapper pl-3">
                        <h5 className="font-weight-medium mb-0">$2300</h5>
                    ...
                    <div className="list-item border-bottom-0">
                      <div className="d-flex align-items-center justify-content-center img-sm badge-gradient-info">
                        <i className="mdi mdi-cash-multiple icon-sm"></i>
                      </div>
                      <div className="wrapper pl-3 w-100">
                        ...
                        <div className="d-flex">
                          <p className="text-muted mb-0">Deposit</p>
                          <p className="font-weight-bold ms-auto">
                            4.7 GB free
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="list-item">
                      <div className="d-flex align-items-center justify-content-center img-sm badge-gradient-primary">
                        <i className="mdi mdi-file-pdf icon-sm"></i>
                      </div>
                      <div className="wrapper pl-3 w-100">
                        <h5 className="font-weight-medium mb-0 ellipsis">
                          Company Profile.pdf
                        ...
                        <div className="d-flex">
                          ...
                          <i className="mdi mdi-arrow-down-bold text-muted ms-auto"></i>
                        </div>
                      </div>
                    </div>
                    <div className="list-item">
                    ...
                    <h5 className="font-weight-medium mt-5 mb-4">
                      Share photos
                    </h5>
                    <div className="row">
                      <div className="col-4">
                        <img
                          ...
                          src={require("../../assets/images/chat/thumb_image1.jpg")}
                          alt="thumb"
                        />
                      </div>
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={require("../../assets/images/chat/thumb_image2.jpg")}
                          alt="thumb"
                        />
                      </div>
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={require("../../assets/images/chat/thumb_image3.jpg")}
                          alt="thumb"
                        />
                      </div>
                    </div>
                    <div className="row my-4">
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={require("../../assets/images/chat/thumb_image4.jpg")}
                          alt="thumb"
                        />
                      </div>
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={require("../../assets/images/chat/thumb_image5.jpg")}
                          alt="thumb"
                        />
                      </div>
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={require("../../assets/images/chat/thumb_image6.jpg")}
                          alt="thumb"
                        />
                      </div>
                    </div>
                    <div className="row mb-4">
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={require("../../assets/images/chat/thumb_image7.jpg")}
                          alt="thumb"
                        />
                      </div>
                      <div className="col-4">
                        <img
                          className="w-100 img-fluid rounded"
                          src={require("../../assets/images/chat/thumb_image8.jpg")}
                          alt="thumb"
                        />
                      </div>
                      <div className="col-4">
