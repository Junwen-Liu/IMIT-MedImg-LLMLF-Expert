...
const initialData = {
  tasks: {
    "task-1": {
      ...
      date: "20 Feb 2019",
      img1URL: require("../../assets/images/faces/female.jpg"),
      img2URL: require("../../assets/images/faces/female.jpg"),
      img3URL: require("../../assets/images/faces/female.jpg"),
      priority: "important",
      dueDate: "Due 10 days",
    ...
    return (
      <div className="col-md-4">
        <div className="border board-wrapper p-3">
          <div>
            <h6 className="card-title">{this.props.column.tittle}</h6>
          </div>
          ...
          >
            <ul id="portlet-card-list-1" className="portlet-card-list">
              <li className="portlet-card">
                <ProgressBar
                  variant={`${this.props.task.progressVariant}`}
                  now={25}
                />
              ...
              <div className="card-body p-3">
                <div className="d-flex flex-column flex-md-row align-items-center flex-wrap">
                  ...
                  <div className="wrapper d-none d-lg-flex  align-items-center my-2">
                    ...
                    <button
                      type="button"
                      className="btn private-btn btn-fw ml-4"
                    >
                  ...
                  <div className="wrapper ml-md-auto  d-none d-lg-flex flex-column flex-md-row kanban-toolbar ml-md-0 my-2">
                    <div className="d-flex">
                      <button
                        type="button"
                        className="btn btn-icons btn-light d-none d-lg-block"
                      >
