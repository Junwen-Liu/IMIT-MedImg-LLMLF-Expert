        ...
        <div className="card">
          <div className="card-body">
            <div className="d-flex mb-4">
              <h5 className="me-2 font-weight-semibold border-right pr-2 me-2">
                Users
              </h5>
                    ...
                    <div className="row">
                      <div className="col-xl-5 d-sm-flex">
                        <div className="user-avatar mb-auto">
                          <img
                            ...
                            alt="profile"
                            className="profile img-lg rounded-circle"
                          />
                        ...
                        <div className="wrapper pl-sm-4">
                          <div className="wrapper d-flex align-items-center">
                            ...
                            <div className="badge badge-secondary text-dark mt-2 ms-2">
                              Pro
                            </div>
                          </div>
                      ...
                      <div className="col-sm-8 col-xl-4">
                        <div className="d-flex align-items-center justify-content-between w-100">
                          <p className="mb-0 me-3 font-weight-semibold">
                            Progress
                          </p>
                      ...
                      <div className="col-sm-4 col-xl-3">
                        <div className="wrapper d-flex justify-content-end">
                          <button
                            type="button"
                            className="btn btn-sm btn-inverse-primary me-2"
                          >
                            ASK
                          </button>
