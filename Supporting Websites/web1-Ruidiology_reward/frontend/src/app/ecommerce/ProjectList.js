              ...
              <div className="card-body">
                <div className="d-flex">
                  <div className="wrapper">
                    ...
                    <p>
                      0 Selected -{" "}
                      <span className="text-primary">Select all projects</span>
                    </p>
                  </div>
                ...
                <div className="row project-list-showcase">
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      <div className="d-flex align-items-start">
                        ...
                        <div className="badge badge-gradient-success ms-auto">
                          Finished
                        </div>
                      </div>
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4">
                            <i className="mdi mdi-view-sequential me-2"></i>50
                          </div>
                          <div className="wrapper">
                            <i className="mdi mdi-message-outline me-2"></i>321
                          </div>
                        </div>
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      ...
                      <div className="d-flex justify-content-between flex-wrap align-items-center">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4">
                            <i className="mdi mdi-view-sequential me-2"></i>45
                          </div>
                          <div className="wrapper">
                            <i className="mdi mdi-message-outline me-2"></i>123
                          </div>
                        </div>
                        <div className="image-grouped">
                          <img
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      <div className="d-flex align-items-start">
                        ...
                        <div className="badge badge-gradient-secondary ms-auto">
                          On going
                        </div>
                      </div>
                      <p className="project-description">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="img-holder img-bg-1"></div>
                    <div className="project-grid-inner">
                      <div className="d-flex align-items-start">
                        <div className="wrapper">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="img-holder img-bg-2"></div>
                    <div className="project-grid-inner">
                      <div className="d-flex align-items-start">
                        <div className="wrapper">
                        ...
                        <div className="badge badge-gradient-danger ms-auto">
                          Hold
                        </div>
                      </div>
                      <p className="project-description">
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4">
                            <i className="mdi mdi-view-sequential me-2"></i>34
                          </div>
                          <div className="wrapper">
                            <i className="mdi mdi-message-outline me-2"></i>453
                          </div>
                        </div>
                        <div className="image-grouped">
                          <img
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="img-holder img-bg-3"></div>
                    <div className="project-grid-inner">
                      <div className="d-flex align-items-start">
                        <div className="wrapper">
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4">
                            <i className="mdi mdi-view-sequential me-2"></i>65
                          </div>
                          <div className="wrapper">
                            <i className="mdi mdi-message-outline me-2"></i>651
                          </div>
                        </div>
                        <div className="image-grouped">
                          <img
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      <img
                        className="mb-3 mt-n3"
                        src={require("../../assets/images/brand_icons/bitmap.jpg")}
                        alt="brand"
                      />
                      <div className="d-flex align-items-start">
                        <div className="wrapper">
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="action-tags d-flex flex-row">
                          ...
                          <div className="wrapper">
                            <i className="mdi mdi-message-outline me-2"></i>466
                          </div>
                        </div>
                        <div className="image-grouped">
                          <img
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      <img
                        className="mb-3 mt-n3"
                        src={require("../../assets/images/brand_icons/oval-copy.jpg")}
                        alt="profile"
                      />
                      <div className="d-flex align-items-start">
                        <div className="wrapper">
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4">
                            <i className="mdi mdi-view-sequential me-2"></i>67
                          </div>
                          <div className="wrapper">
                            <i className="mdi mdi-message-outline me-2"></i>543
                          </div>
                        </div>
                        <div className="image-grouped">
                          <img
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      <img
                        className="mb-3 mt-n3"
                        src={require("../../assets/images/brand_icons/oval.jpg")}
                        alt="brand"
                      />
                      <div className="d-flex align-items-start">
                        <div className="wrapper">
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4">
                            <i className="mdi mdi-view-sequential me-2"></i>87
                          </div>
                          <div className="wrapper">
                            <i className="mdi mdi-message-outline me-2"></i>558
                          </div>
                        </div>
                        <div className="image-grouped">
                          <img
